...
val md_theme_light_primaryContainer = Color(0xFFDBFFB2)
...
val md_theme_light_inversePrimary = Color(0xFFF0F8A4)
val md_theme_light_surfaceTint = Color(0xFFA4AD48)
val md_theme_light_outlineVariant = Color(0xFFD5C2C6)
val md_theme_light_scrim = Color(0xFF000000)

val md_theme_dark_primary = Color(0xFFFFB0C9)
val md_theme_dark_onPrimary = Color(0xFF2B7971)
val md_theme_dark_primaryContainer = Color(0xFF29A22E)
...
val md_theme_dark_inversePrimary = Color(0xFFAECA8C)
val md_theme_dark_surfaceTint = Color(0xFFF1F8A5)
